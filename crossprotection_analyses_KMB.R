...
# Load data
fullexp = read.csv("/Users/kmbarnett/Documents/2020_fall/cross protection/data/kmb_load_data_for_stats copy.csv")

library(glmmTMB)

# Zero-inflated negative binomial model on Bd counts for 3x2 experimental design
infection_intensity_model = glmmTMB(round(final.bd.load) ~ Vaccine*Live.Bd, family="nbinom2", ziformula = ~1, data = fullexp)
...
ASW_v_CA = read.csv("/Users/kmbarnett/Documents/2021 winter/cross protection/cross protection stats/kmb_vaxstrain2.csv")
...
PA_v_CA = read.csv("/Users/kmbarnett/Documents/2021 winter/cross protection/cross protection stats/kmb_vaxstrain3.csv")
